...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			statement.executeUpdate(sql); // excuteUpdate() write, executeQuery() read

			sql = "DROP TABLE IF EXISTS history"; // ensure the order of removing
			statement.executeUpdate(sql);		// in case there're foreign keys in other tables
			...
			sql = "INSERT INTO users VALUES('0001', '3229c1097c00d497a0fd282d586be050', 'Erica', 'Zhang')";
			statement.executeUpdate(sql);
